	...
	var Carousel = {
		...
		lazyPreload : function($item,$lazyImg){
			...
			function showImage(){
				...
				base.options.lazyEffect === "fade" ? $lazyImg.fadeIn(400, function() { addHelperClasses($lazyImg); }) : $lazyImg.show(function() { addHelperClasses($lazyImg); });
				
			}
			/* BEGIN - Added By GFashion Template */
			function addHelperClasses($lazyImg) {
				var w = $lazyImg.width(),
					h = $lazyImg.height(),
					r = w/h;
				if ( ! isNaN(r) )
					( r < 1 ) ? $lazyImg.addClass('img-portrait') : $lazyImg.addClass('img-landscape');
			}
			/* END - Added By GFashion Template */
		},
